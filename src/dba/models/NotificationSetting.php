...
class NotificationSetting extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['notificationSettingId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "notificationSettingId", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['action'] = ['read_only' => False, "type" => "str(50)", "subtype" => "unset", "choices" => ["taskComplete" => "Task completed", "agentError" => "Agent error", "ownAgentError" => "Own agent error", "logError" => "Log error", "newTask" => "New task", "newHashlist" => "New hashlist", "hashlistAllCracked" => "Hashlist all cracked", "hashlistCrackedHash" => "Hashlist cracked hash", "userCreated" => "User created", "userDeleted" => "User deleted", "userLoginFailed" => "User login failed", "logWarn" => "Log warning", "logFatal" => "Log fatal", "newAgent" => "New agent", "deleteTask" => "Delete task", "deleteHashlist" => "Delete hashlist", "deleteAgent" => "Delete agent", ], "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "action", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['objectId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => True, "pk" => False, "protected" => True, "private" => False, "alias" => "objectId", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['notification'] = ['read_only' => False, "type" => "str(50)", "subtype" => "unset", "choices" => ["ChatBot" => "ChatBot", "Discord Webhook" => "Discord Webhook", "Email" => "Email", "Example" => "Example", "Slack" => "Slack", "Telegram" => "Telegram", ], "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "notification", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['userId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "userId", "public" => False, "reference" => "User", "dba_mapping" => False];
    $dict['receiver'] = ['read_only' => False, "type" => "str(256)", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "receiver", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['isActive'] = ['read_only' => False, "type" => "bool", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "isActive", "public" => False, "reference" => False, "dba_mapping" => False];
