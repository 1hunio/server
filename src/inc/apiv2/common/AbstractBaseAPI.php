...
abstract class AbstractBaseAPI {
  ...
  /** @var User $user is currently logged in user */
  private User $user;
  ...
  protected function obj2Resource(AbstractModel $obj, array &$expandResult = [], ?array $sparseFieldsets = null, ?array $aggregateFieldsets = null): array {
    ...
    foreach ($features as $name => $feature) {
      ...
      // Hide the primaryKey from the attributes since this is used as identifier (id) in response
      if ($feature['pk'] === true) {
        continue;
      }
